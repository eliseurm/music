export const EXEMP_XML = `<?xml version="1.0" encoding="UTF-8"?>
...
<score-partwise version="4.0">
  <identification>
    ...
    <miscellaneous>
      <miscellaneous-field name="creationDate">2026-02-03</miscellaneous-field>
  ...
  <part id="P1">
    <measure number="1" width="197.41">
      ...
      <note default-x="81.18" default-y="-20">
        <rest/>
        <duration>1</duration>
        <voice>1</voice>
        <type>quarter</type>
        </note>
      <note default-x="119.32" default-y="-25">
        <pitch>
          <step>C</step>
          <octave>3</octave>
          </pitch>
      ...
      <note default-x="157.47" default-y="-25">
        <pitch>
          <step>C</step>
          <alter>1</alter>
          <octave>3</octave>
    ...
    <measure number="2" width="128.74">
      ...
      <note default-x="50.65" default-y="-20">
        <pitch>
          <step>D</step>
          <alter>-1</alter>
          <octave>3</octave>
      ...
      <note default-x="88.79" default-y="-20">
        <pitch>
          <step>D</step>
          <alter>1</alter>
          <octave>3</octave>
    ...
    <measure number="3" width="128.74">
      ...
      <note default-x="50.65" default-y="-15">
        <pitch>
          <step>E</step>
          <alter>-1</alter>
          <octave>3</octave>
    ...
    <measure number="4" width="128.74">
      ...
      <note default-x="50.65" default-y="-10">
        <pitch>
          <step>F</step>
          <octave>3</octave>
          </pitch>
      ...
      <note default-x="88.79" default-y="-10">
        <pitch>
          <step>F</step>
          <alter>1</alter>
          <octave>3</octave>
    ...
    <measure number="5" width="128.74">
      ...
      <note default-x="50.65" default-y="-5">
        <pitch>
          <step>G</step>
          <alter>-1</alter>
          <octave>3</octave>
      ...
      <note default-x="88.79" default-y="-5">
        <pitch>
          <step>G</step>
          <alter>1</alter>
          <octave>3</octave>
    ...
    <measure number="6" width="128.74">
      ...
      <note default-x="50.65" default-y="0">
        <pitch>
          <step>A</step>
          <alter>-1</alter>
          <octave>3</octave>
      ...
      <note default-x="88.79" default-y="0">
        <pitch>
          <step>A</step>
          <alter>1</alter>
          <octave>3</octave>
